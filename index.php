...
<div class="jumbotron jumboClass">
  <div class="container center topContainer">
    <h1>IT en design onder één dak!</h1>
    <p>Samen maken ze meer.</p>
  </div>
</div>
...
<div class="row">
        ...
        <div class="col-lg-3">
          <img class="img-circle imgRatio" src="images/hardware_round.png" alt="Hardware" width="140" height="140">
        ...
        <div class="col-lg-3">
          <img class="img-circle imgRatio" src="images/software_round.png" alt="Software" width="140" height="140">
        ...
        <div class="col-lg-3">
          <img class="img-circle imgRatio" src="images/drukwerk_round.png" alt="Drukwerk" width="140" height="140">
...
<div class="about">
  <div class="container aboutText">
    ...
    <div class="row featurette aboutMargin" margin-top="40px;">
      <div class="col-md-9">
        <h2 class="featurette-heading">Rick van der Poel <span class="text-muted">- ZZP'er/Freelancer</span></h2>
        <p class="text-justify"><b>Mijn achtergrond</b> - Ik heb ervaring in de ICT opgedaan door mijn interesse in computers en ben om die reden begonnen met de opleiding ICT niveau 2. Na het behalen van een ICT niveau 2 diploma, ben ik door gegaan voor mijn niveau 3 diploma en ben ik daarna door mijn hobby (het maken van websites) richting de opleiding Mediavormgeving gegaan. Inmiddels heb ik ook hier mijn diploma gehaald als Interactieve Vormgever niveau 4 en studeer ik momenteel informatica aan de Hanzehogeschool in Groningen om mijn kennis in de ICT sector nog verder te verbreden. Voor partime werk heb ik vdPoel - Computing & Design opgestart. Hierdoor kan ik mijn passie in mijn vrije tijd uitvoeren door anderen te helpen met zowel design als ICT werk.</p>
      </div>

      <div class="col-md-3">
        <img class="img-circle img-responsive center-block" src="images/rick.png" alt="Generic placeholder image">
      </div>
    </div>
